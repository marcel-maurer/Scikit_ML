...
class Config:
    # Dataset
    target: str = None
    csv_path: str = r"/run/media/drdrakken/Elements/Sonstiges/Programmieren/Machine Learning/Part 8 - Deep Learning/Section 39 - Artificial Neural Networks (ANN)/Part 11 - Ml Portfolio/CSVData/CreditFraud/cs-training.csv"
